...
class MainFrame(wx.Frame):
    ...
    def __init__(self):
        ...
        # Set wx.WANTS_CHARS resources for the keyboard to work.
        # This resources also needs to be set for all parent controls.
    ...
    def setup_icon(self):
        icon_file = "/resources/Icojam-Blue-Bits-Database-settings.ico"
    ...
    def create_menu(self):
        devMenu = wx.Menu()
        menu11 = devMenu.Append(11, "Configuration")
        devMenu.Append(12, "Templates")
        devMenu.Append(13, "Generator")
        devMenu.Append(14, "Testing")
        repoMenu = wx.Menu()
        opsMenu = wx.Menu()
        opsMenu.Append(31, "Deployment")
        opsMenu.Append(32, "Scheduling")
        opsMenu.Append(33, "Monitoring")
        infoMenu = wx.Menu()
        infoMenu.Append(41, "Settings")
        infoMenu.Append(42, "About")
        menu43 = infoMenu.Append(wx.ID_EXIT, 'Quit', 'Quit application')
        menubar = wx.MenuBar()
        menubar.Append(devMenu, "&Development")
        menubar.Append(repoMenu, "&Repository")
        menubar.Append(opsMenu, "&Operations")
        menubar.Append(infoMenu, "&Info")
        self.SetMenuBar(menubar)
        self.Bind(wx.EVT_MENU, self.YesNo, menu11)

    def YesNo(self,e):
        print(self.browser.GetFocusedFrame())
        self.browser.SetPage("<html><body>a</body></html>")
            #LoadUrl("/resources/configuration.html")

    def embed_browser(self):
        window_info = cef.WindowInfo()
        (width, height) = self.browser_panel.GetClientSize().Get()
        window_info.SetAsChild(self.browser_panel.GetHandle(), [0, 0, width, height])
        self.browser = cef.CreateBrowserSync(window_info, url="/gui2.html")
